                    ...
                    <div class="col-md-4 offset-md-4">
                        <form action="{{ url('programs') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="tahun_kelahiran" class="form-control @error('tahun_kelahiran') is-invalid @enderror" value="{{ old('student_price') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="tahun_kelulusan" class="form-control @error('tahun_kelulusan') is-invalid @enderror" value="{{ old('student_max') }}">
